...
from utils.vocab import tokenize_statement_file, tokenize_sentence
...
from utils.paths import find_paths, score_paths, prune_paths, find_relational_paths_from_paths
...
def main():
    ...
    parser.add_argument('--run', default=['common', 'csqa'], choices=['common', 'csqa', 'hswag', 'anli', 'exp', 'scitail', 'phys', 'socialiqa', 'obqa'], nargs='+')
    ...
    routines = {
        'common': [
            ...
            {'func': load_pretrained_embeddings, 'args': (output_paths['numberbatch']['npy'], output_paths['numberbatch']['vocab'], output_paths['cpnet']['vocab'], False, output_paths['numberbatch']['concept_npy'])},
